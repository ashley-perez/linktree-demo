function Profile() {
  return (
    <header className="flex flex-col items-center font-akt">
      ...
      <p className="text-gray-600 text-center w-40 md:w-full text-xs md:text-lg ">I make things :)</p>
      <p className="text-gray-600 text-center text-[8px] md:text-xs ">placeholder</p>
